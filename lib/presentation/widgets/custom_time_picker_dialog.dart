...
class _CustomTimePickerDialogState extends State<CustomTimePickerDialog>
  ...
  void _handleCancel() {
    Navigator.pop(context, {
      'state': TimePickerCallbackState.Cancel,
    });
  }

  void _handleNoTime() {
    Navigator.pop(context, {
      'state': TimePickerCallbackState.No_TIME,
    });
  }
  ...
  void _handleOk() {
    ...
    Navigator.pop(context,
        {'state': TimePickerCallbackState.Ok, 'value': _selectedTime.value});
  }
...
Future<Map<String, dynamic>?> showCustomTimePicker({
